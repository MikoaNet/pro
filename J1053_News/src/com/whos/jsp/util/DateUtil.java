...
public class DateUtil {
	...
	//转换日期到字符串  不带时 分 秒
	public static String getDateSimpleString(java.util.Date date) {
		if (date == null)
			return null;
	...
	//按照指定格式化日期  返回日期字符串
	public static String getDateSimpleString(java.util.Date date, String format) {
		if (date == null)
			return null;
		if (format == null)
	...
	public static void main(String[] args) {
		...
		System.out.println(DateUtil.getDateSimpleString(new Date()));

		Date date1 = DateUtil.getDate("2018-1-30 12:12:12");
		System.out.println(DateUtil.getTimeSimpleString(date1));

		Date date2 = DateUtil.getBirthDate("2018-1-30 12:12:12");
